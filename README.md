...
> **Note:** Replace the DOI badge above with the one generated by Zenodo after connecting this repository and minting a release DOI.
...
> Replace `10.5281/zenodo.PLACEHOLDER` with the actual DOI after Zenodo registration.
